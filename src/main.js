...
camera.position.set(3.4, 3.2, 6.4);
...
// --- Lighting --------------------------------------------------------------
scene.add(new THREE.HemisphereLight(0x8899cc, 0x080810, 0.55));

const keyLight = new THREE.DirectionalLight(0xffffff, 1.5);
keyLight.position.set(4, 8, 5);
scene.add(keyLight);

const rimLight = new THREE.DirectionalLight(0x4a6cff, 1.2);
rimLight.position.set(-5, 3, -4);
scene.add(rimLight);

// Warm fill that intensifies as the character catches fire.
const fireLight = new THREE.PointLight(0xff5a1f, 0.0, 12, 2);
fireLight.position.set(0, 2.4, 1.5);
scene.add(fireLight);
...
const grid = new THREE.GridHelper(28, 28, 0x24304f, 0x141a2c);
